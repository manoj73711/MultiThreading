...
public class Worker {
	...
	// Below line is create the lock objects to syncronize the blocks in staging
	// methods
	...
	public void main() {
		System.out.println("hello I am Present");
		...
		System.out.println("List 1 size is: " + list1.size() + " List 2 size is: " + list2.size());
	}
}
